...
public class DataTypesDemo {
	...
	//	char c2 = "B";
		...
		//***Important point to remember on memory level
		
		//** All primitive data type declared value will get stored in program's stack like int a = 10.
		//** All Wrapper data types objects will get stored in heap memory.
